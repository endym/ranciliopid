...
double& brewtime = sysParam[SYS_PARAM_BREW_TIME];  //brewtime in ms (reference of parameter array entry)
double totalbrewtime = 0; //total brewtime set in softare or blynk
double& preinfusion = sysParam[SYS_PARAM_PRE_INFUSION_TIME];  //preinfusion time in ms (reference of parameter array entry)
double& preinfusionpause = sysParam[SYS_PARAM_PRE_INFUSION_PAUSE];   //preinfusion pause time in ms (reference of parameter array entry)
